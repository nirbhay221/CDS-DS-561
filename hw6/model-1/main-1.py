...
# Connector object to establish a database connection
connector = Connector()
...
def main():
    ...
    print(len(df))
    print(df.head())
    # Apply label encoding to 'country' and 'client_ip' columns
    ...
    random_state_values = range(0,100)  # Test random_state from 0 to 100

    # Lists to store training and test accuracy scores
    train_accuracies = []
    test_accuracies = []

    # List of classifiers to test - Decision Tree Classifier
    classifiers = [
