...
#   db_conn.execute(insert_stmt, parameters={"name": "BÃƒâ‚¬NH MÃƒÅ’", "origin": "Vietnam", "rating": 9.1})
...
topic_path = "projects/cdsds561-project-1/topics/my-pubsub-topic"
